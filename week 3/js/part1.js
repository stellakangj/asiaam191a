...
let circleMarker = L.circleMarker([34.0709, -118.444], {
  ...
  createButtons(34.07,-118.44,'Lu Valle','Great takeout option');
  createButtons(34.05,-118.45,'Tsujita LA Artisan Noodles','This is one of my favorite places to get ramen in Sawtelle!');
  createButtons(34.04,-118.44,'Beard Papas','This is where Professor Albert bought the Asian Am 191 Spring 2023 class cream puffs.');
  createButtons(34.0381,-118.442,'Artelice Patesserie','This is a bakery in Sawtelle that I visited with my friends over spring break. So good!');
